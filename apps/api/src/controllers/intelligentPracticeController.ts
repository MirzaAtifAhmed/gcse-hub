  ...
  return res.json({
    ...
    data: {
      topics: [
        ...
        { value: 'Indices', label: 'Index laws' },
        { value: 'Surds', label: 'Surds' },
        { value: 'Sequences', label: 'Sequences and nth term' },
        { value: 'Quadratics', label: 'Quadratics and factorising' },
        { value: 'Bearings', label: 'Bearings' },
        { value: 'Circle', label: 'Circle area and circumference' },
        { value: 'Volume', label: 'Volume and 3D shapes' },
        { value: 'Transformations', label: 'Transformations' },
        { value: 'Scatter graphs', label: 'Scatter graphs and correlation' },
        { value: 'Venn diagrams', label: 'Venn diagrams' },
      ],
      difficulties: [
