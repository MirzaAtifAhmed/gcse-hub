...
export type QuestionTemplateDocument = InferSchemaType<typeof questionTemplateSchema> & {
  _id: mongoose.Types.ObjectId;
};

export const QuestionTemplate = mongoose.model<QuestionTemplateDocument>(
  'QuestionTemplate',
